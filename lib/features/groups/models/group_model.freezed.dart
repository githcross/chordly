...
class _$GroupModelImpl implements _GroupModel {
  ...
  @override
  String toString() {
    return 'GroupModel(id: $id, name: $name, description: $description, imageUrl: $imageUrl, createdBy: $createdBy, memberCount: $memberCount, isActive: $isActive, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, name, description, imageUrl,
      createdBy, memberCount, isActive, createdAt, updatedAt);
