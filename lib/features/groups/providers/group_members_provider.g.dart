...
String _$groupMembersHash() => r'b530225d562dd199b0b984335e7c7b447856d3c8';
...
class GroupMembersProvider
    extends AutoDisposeStreamProvider<List<GroupMembership>> {
  /// See also [groupMembers].
  ...
  Override overrideWith(
    Stream<List<GroupMembership>> Function(GroupMembersRef provider) create,
  ) {
  ...
  @override
  AutoDisposeStreamProviderElement<List<GroupMembership>> createElement() {
...
mixin GroupMembersRef on AutoDisposeStreamProviderRef<List<GroupMembership>> {
  /// The parameter `groupId` of this provider.
  String get groupId;
}

class _GroupMembersProviderElement
    extends AutoDisposeStreamProviderElement<List<GroupMembership>>
